...
public class GenerateErlangForFIXFieldsRecord {
	...
	public static void generateFixFiledFile(String destination, List<FixRawField> fields) throws IOException {
		...
		fix_field.write(
				...
				+ "    end.\n"
				+ "\n"
				+ "-spec is_valid_field(F) -> boolean() when\n"
				+ "        F :: {fix_field()}.\n"
				+ "is_valid_field(F) -> \n"
				+ "    is_defined(F#fix_field.id),\n"
				+ "    is_defined(F#fix_field.value),\n"
				+ "    is_defined(F#fix_field.descriptor).\n"
				+ "\n"
				+ "%% ====================================================================\n"
				+ "%% Internal functions\n"
				+ "%% ====================================================================\n"
				...
				+ "    is_defined(FD#fix_field_descriptor.name),\n"
				+ "    is_defined(FD#fix_field_descriptor.xml_tag),\n"
				+ "    is_defined(FD#fix_field_descriptor.tranform),\n"
				+ "    is_defined(FD#fix_field_descriptor.version),\n"
				+ "    is_defined(FD#fix_field_descriptor.accepted_values).\n"
				+ "\n"
